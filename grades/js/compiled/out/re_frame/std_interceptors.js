...
var vec__8401_8404 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_8405 = cljs.core.nth.call(null,vec__8401_8404,(0),null);
var only_after_8406 = cljs.core.nth.call(null,vec__8401_8404,(1),null);
var db_changed_QMARK__8407 = (cljs.core.some_QMARK_.call(null,only_before_8405)) || (cljs.core.some_QMARK_.call(null,only_after_8406));
if(db_changed_QMARK__8407){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for: ",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before: ",only_before_8405);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after : ",only_after_8406);
...
var map__8414 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__8414__$1 = ((((!((map__8414 == null)))?((((map__8414.cljs$lang$protocol_mask$partition0$ & (64))) || (map__8414.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__8414):map__8414);
var db = cljs.core.get.call(null,map__8414__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__8414__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__8422 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__8422__$1;
var event = cljs.core.get.call(null,map__8422__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__7484__auto___8425 = arguments.length;
var i__7485__auto___8426 = (0);
while(true){
if((i__7485__auto___8426 < len__7484__auto___8425)){
args__7491__auto__.push((arguments[i__7485__auto___8426]));

var G__8427 = (i__7485__auto___8426 + (1));
i__7485__auto___8426 = G__8427;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq8424){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq8424));
});
...
var args__7491__auto__ = [];
var len__7484__auto___8433 = arguments.length;
var i__7485__auto___8434 = (0);
while(true){
if((i__7485__auto___8434 < len__7484__auto___8433)){
args__7491__auto__.push((arguments[i__7485__auto___8434]));

var G__8435 = (i__7485__auto___8434 + (1));
i__7485__auto___8434 = G__8435;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__8428_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__8429_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__8429_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq8430){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__8431,G__8432,seq8430__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1481235361021