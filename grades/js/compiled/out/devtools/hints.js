...
var temp__4655__auto___11885 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___11885)){
var seen_errors_11886 = temp__4655__auto___11885;
if(cljs.core.truth_(seen_errors_11886.has(self))){
} else {
seen_errors_11886.add(self);

var temp__4657__auto___11887 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___11887)){
var sense_11888 = temp__4657__auto___11887;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_11888)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1481235365587