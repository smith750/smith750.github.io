...
var args11595 = [];
var len__7484__auto___11601 = arguments.length;
var i__7485__auto___11602 = (0);
while(true){
if((i__7485__auto___11602 < len__7484__auto___11601)){
args11595.push((arguments[i__7485__auto___11602]));

var G__11603 = (i__7485__auto___11602 + (1));
i__7485__auto___11602 = G__11603;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox11598 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox11598 = (function (obj,header,style,tag,meta11599){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox11598.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_11600,meta11599__$1){
var self__ = this;
var _11600__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox11598(self__.obj,self__.header,self__.style,self__.tag,meta11599__$1));
});

devtools.toolbox.t_devtools$toolbox11598.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_11600){
var self__ = this;
var _11600__$1 = this;
return self__.meta11599;
});

devtools.toolbox.t_devtools$toolbox11598.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox11598.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox11598.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox11598.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox11598.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta11599","meta11599",-1207403156,null)], null);
});

devtools.toolbox.t_devtools$toolbox11598.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox11598.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox11598";

devtools.toolbox.t_devtools$toolbox11598.cljs$lang$ctorPrWriter = (function (this__7015__auto__,writer__7016__auto__,opt__7017__auto__){
return cljs.core._write.call(null,writer__7016__auto__,"devtools.toolbox/t_devtools$toolbox11598");
});

devtools.toolbox.__GT_t_devtools$toolbox11598 = (function devtools$toolbox$__GT_t_devtools$toolbox11598(obj__$1,header__$1,style__$1,tag__$1,meta11599){
return (new devtools.toolbox.t_devtools$toolbox11598(obj__$1,header__$1,style__$1,tag__$1,meta11599));
});

}

return (new devtools.toolbox.t_devtools$toolbox11598(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1481235365255